...
=                   懒加载                      =
============================================= */
const AppSetting = defineAsyncComponent(() => import('./components/AppSetting/index.vue'));
const Copyright = defineAsyncComponent(() => import('./components/Copyright/index.vue'));
const SettingBar = defineAsyncComponent(() => import('./components/SettingBar/index.vue'));
...
<template>
  <div class="layout">
    ...
    <HotkeysIntro />
    <template v-if="settingsStore.settings.app.enableAppSetting && isDev">
      <SettingBar />
      <AppSetting />
    </template>
    <BackTop />
